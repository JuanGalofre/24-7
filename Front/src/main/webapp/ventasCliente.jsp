...
<body>
	...
	<div class="rightbar">
        ...
        <form action="./StoresServlet" class="form-box">
			...
			if(mensaje2 != null){
		    %>  
	        <label for="message"> <%= mensaje2 %></label>
	    	<% 
			}
	    	%>  
