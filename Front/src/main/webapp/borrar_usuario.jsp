...
<body>
	...
	<div class="rightbar">
        ...
        <form action="./StoresServlet" class="form-box" mode="GET">
            <h1 class="form-title">Borrar usuario</h1>
          
            <label for="username" >Ingresar cédula del usuario</label>
            <input type="text" name="ingresar_cedula_usuario" placeholder="">
            <button type="submit" name="borrar_usuario">
                Borrar
            </button>
            <%
            String mensaje =(String) request.getAttribute("mensaje_borrar_usuario");
            %>
            <%			
			if(mensaje != null){
		    %>  
