...
<title>Menu de administración &middot; sección productos </title>
...
<body>
	<div class="leftbar">
		...
		%>			   
		<div class="rightbar_products">
			<div class="container_products">
				<div class="container_products_inside">
				<form action="./StoresServlet" method="post">
					<span>Sube el archivo (.csv) con los productos</span><br>
					<input class="file-upload__input" type="file" name="ruta_archivo" id="myFile" multiple>
					<button type="submit" name="guardar_productos">Seleccionar archivo csv</button>
				</form>
				<%
					if(mensaje != null){
				%>
