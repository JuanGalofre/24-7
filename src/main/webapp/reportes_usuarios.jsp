				...
				<div class="list-box-container">
					...
					<div class="list-box">
						<div class="list-get-text">
							<span>Cedula:</span>
							<span class="dinamyc-text"><%= usuario.getCedula_usuario()%></span>
							<span>Nombre:</span>
							<span class="dinamyc-text"><%=usuario.getNombre_usuario()%></span>
							<span>Correo:</span>
							<span class="dinamyc-text"><%=usuario.getEmail_usuario()%></span>
						</div>
					</div>
				<%     } %>
				</div>
