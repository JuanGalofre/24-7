	...
	<div class="rightbar">
		<div class="form-box-container">
        	<form action="./StoresServlet" class="form-box">
                ...
                <input type="text" name="cedula_usuario" placeholder="" required="">
                <label for="correo" > Correo electronico</label>
                <input type="text" name="correo_usuario"  placeholder="usuario@dominio.es" required="">
                <label for="clave">Contraseña</label>
                <input type="password" name="clave_usuario" placeholder="" required="">
                <label for="clave2" >Confirmar contraseña</label>
                <input type="password" id="clave2" placeholder="" required="">
