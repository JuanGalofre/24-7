				...
				<div class="list-box-container">
					...
					<div class="list-box">
						<div class="list-get-text">
							<span>Cedula:</span>
							<span class="dinamyc-text"><%= cliente.getCedula_cliente()%></span>
							<span>Dirección:</span>
							<span class="dinamyc-text"><%= cliente.getDireccion_cliente()%></span>
							<span>Correo:</span>
							<span class="dinamyc-text"><%= cliente.getEmail_cliente()%></span>
							<span>Nombre:</span>
							<span class="dinamyc-text"><%= cliente.getNombre_cliente()%></span>
							<span>Teléfono:</span>
							<span class="dinamyc-text"><%= cliente.getTelefono_cliente()%></span>
						</div>
					</div>
					<%
						}
