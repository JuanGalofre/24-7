...
<body>
	...
	<div class="rightbar">
        ...
        <form action="./StoresServlet" class="form-box">
            <h1 class="form-title">Borrar cliente</h1>
          
            <label for="username" >Ingresar cédula del cliente</label>
            <input type="text" name="ingresar_cedula_cliente" placeholder="">
            <button type="submit" name="borrar_cliente">
                Borrar
            </button>
			 <%
            String mensaje =(String) request.getAttribute("mensaje_borrar_cliente");
            %>
            <%			
			if(mensaje != null){
		    %>  
